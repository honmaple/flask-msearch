...
# Last Update:星期五 2017-6-2 13:43:54 (CST)
#          By:
# Description:
# **************************************************************************
import os
...
class WhooshSearch(BaseBackend):
    ...
    def _schema(self, model):
        ...
        default_type = TEXT(stored=True, analyzer=analyzer, sortable=False)
        type_map = {
            Date: DATETIME(
            ...
            DateTime: DATETIME(
                stored=True, sortable=True),
            Integer: NUMERIC(
                stored=True, numtype=int),
            Float: NUMERIC(
                stored=True, numtype=float),
        ...
        for field in searchable:
            ...
            if field in primary_keys:
                ...
                schema_fields[field] = type_map.get(field_type, default_type)
